...
@implementation BuffetImagLableCell
...
- (void)layoutSubviews{
    ...
    [self.flagImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.whiteView.mas_left).offset(40);
    ...
    [self.labelBgView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self.flagImageView.mas_right);
