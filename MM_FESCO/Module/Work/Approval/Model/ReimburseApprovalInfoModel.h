...
#import "ReimburseApprovalInfoDetailsModel.h"
/*
 "account_Id" = 1401;
 "account_Name" = "<null>";
 ...
 "group_Id" = 4;
 "group_Name" = "\U85aa\U916c\U4e8b\U4e1a\U90e8";
 memo = Ceshi;
 "money_Sum" = "<null>";
 "search_Begin" = "<null>";
 "search_End" = "<null>";
...
@interface ReimburseApprovalInfoModel : NSObject
